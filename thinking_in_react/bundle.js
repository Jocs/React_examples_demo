...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_components.FilterableProductTable, { products: _data.PRODUCTS }), document.querySelector('#container'));
...
/***/ function(module, exports) {
	...
	var PRODUCTS = exports.PRODUCTS = [{ category: 'Sporting Goods', price: '$49.99', stocked: true, name: 'Football' }, { category: 'Sporting Goods', price: '$9.99', stocked: true, name: 'Baseball' }, { category: 'Sporting Goods', price: '$29.99', stocked: false, name: 'Basketball' }, { category: 'Electronics', price: '$99.99', stocked: true, name: 'iPod Touch' }, { category: 'Electronics', price: '$399.99', stocked: false, name: 'iPhone 5' }, { category: 'Electronics', price: '$199.99', stocked: true, name: 'Nexus 7' }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = (function (_React$Component4) {
		...
		function SearchBar(props) {
			...
			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(SearchBar).call(this, props));

			_this4.state = {
				text: _this4.props.filterText,
				inStockOnly: _this4.props.inStockOnly
			};
			return _this4;
		}
		...
		_createClass(SearchBar, [{
			...
			value: function handleChange(event) {
				...
				var update = target.type === 'text' ? { text: target.value } : { inStockOnly: target.checked };
				//this.setState(object, callback);可以接受一个回调函数
				this.setState(Object.assign({}, this.state, update), function () {
					_this5.props.onUserInput(_this5.state.text, _this5.state.inStockOnly);
				});
			}
		}]);
	...
	var FilterableProductTable = (function (_React$Component5) {
		...
		function FilterableProductTable(props) {
			...
			var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(FilterableProductTable).call(this, props));
